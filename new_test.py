...
def show_market_share():
    ...
    <div style='background:rgba(0,255,255,0.05);border:1px solid #00ffff33;
                border-radius:10px;padding:16px;margin-bottom:16px;'>
    <b style='color:#00ffff;'>What this page does</b><br>
    Cross-references the <b>BDC Stock Balance</b> and <b>OMC Loadings</b> datasets to
    show a selected BDC's position in the national market — both by the fuel it currently
    holds in depot (stock share) and the fuel it has dispatched to OMCs (sales share).
    Rankings are computed per-product so you can see where a BDC leads or lags.<br><br>
    <b style='color:#ff00ff;'>Prerequisite:</b> Fetch <b>BDC Balance</b> and
    <b>OMC Loadings</b> data first from their respective pages.
    </div>
    """, unsafe_allow_html=True)
